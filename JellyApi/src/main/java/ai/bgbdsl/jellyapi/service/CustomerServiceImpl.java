 ...
 *******************************************************************************/
package ai.bgbdsl.jellyapi.service;
...
import ai.bgbdsl.jellyapi.domain.Customer;
import ai.bgbdsl.jellyapi.repository.CustomerRepository;
...
public class CustomerServiceImpl implements CustomerService {
	...
	public Customer updateCustomer(final Long id, final Customer customer) {
		...
		fetchedCustomer.setCompanyname(customer.getUsername());
	...
	public Customer patchCustomer(Long id, Customer customer) {
		...
		if (customer.getCompanyname() != null) {
			fetchedCustomer.setCompanyname(customer.getCompanyname());
		}
